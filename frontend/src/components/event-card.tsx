...
const confColor = (c: string, th: Theme) =>
      ...
      <View style={styles.cover}>
        ...
        {reasonLabel ? (
          <View style={styles.reasonPill}>
            <Ionicons name={reasonKind === "genre" ? "musical-notes" : "heart"} size={11} color={th.accentInk} />
        ...
        <View style={styles.foot}>
          ...
          {event.confidence ? (
            <View style={styles.confPill}>
              <View style={[styles.dot, { backgroundColor: confColor(event.confidence, th) }]} />
...
const makeStyles = (th: Theme) => StyleSheet.create({
  card: { backgroundColor: th.panel, borderColor: th.line, borderWidth: 1, borderRadius: 16, overflow: "hidden", marginBottom: 14 },
  cover: { height: 150, justifyContent: "flex-end", padding: 12, overflow: "hidden" },
  fill: { position: "absolute", top: 0, left: 0, right: 0, bottom: 0 },
  save: {
    position: "absolute", top: 10, right: 10,
    backgroundColor: alpha(th.shadow, 0.38), borderRadius: 999, padding: 7,
  },
  reasonPill: {
    position: "absolute", top: 12, left: 12, maxWidth: "72%",
    flexDirection: "row", alignItems: "center", gap: 4,
    backgroundColor: th.accentFill, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3,
  },
  reasonText: { color: th.accentInk, fontSize: 12, fontWeight: "800", flexShrink: 1 },
  flag: { color: "#fff", fontWeight: "800", fontSize: 14, textShadowColor: th.scrim, textShadowRadius: 6, textShadowOffset: { width: 0, height: 1 } },
  body: { padding: 14 },
  when: { color: th.muted, fontSize: 12, textTransform: "uppercase", letterSpacing: 0.7 },
  title: { color: th.text, fontSize: 20, fontWeight: "800", marginVertical: 3 },
  where: { color: th.muted, fontSize: 13 },
  ...
  noscorePill: { borderWidth: 1, borderColor: th.line, borderStyle: "dashed", borderRadius: 999, paddingVertical: 4, paddingHorizontal: 10, backgroundColor: th.panel2 },
  noscoreText: { color: th.muted, fontSize: 12 },
  confPill: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: th.panel2, borderColor: th.line, borderWidth: 1, borderRadius: 999, paddingVertical: 4, paddingHorizontal: 10 },
  dot: { width: 7, height: 7, borderRadius: 4 },
  confText: { color: th.muted, fontSize: 12 },
});